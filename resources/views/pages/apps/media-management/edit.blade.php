<x-default-layout>
    ...
    @section('breadcrumbs')
        <h2>{{ Breadcrumbs::render('media-management.edit') }}</h2>
    @endsection
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="px-7 py-5 pt-15">
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="media_name" class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">Media Name</label>
                                <br>
                                <br>
                                <input type="text" class="form-control form-control-solid" id="media_name" name="media_name" placeholder="TV Media" style="background-color: rgb(245, 245, 245);">
                            </div>
                        </div>
                        <!-- Media Type Column -->
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">Media Type</label>
                                <br>
                                <br>
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="file" class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">File</label>
                                <br>
                                <br>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="order_by" class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">Order by</label>
                                <br>
                                <br>
                                <input type="number" class="form-control form-control-solid" id="order_by" name="order_by" placeholder="1" style="background-color: rgb(245, 245, 245);">
                            </div>
                        </div>
                    </div>
                    <div class="row mb-10">
                        <div class="col-md-10">
                            <div class="mb-3">
                                ...
                                <br>
                                <br>
                                <textarea class="form-control form-control-solid" id="description" name="description" placeholder="This is description" style="background-color: rgb(245, 245, 245);"></textarea>
                            </div>
                        </div>
                    </div>
                    <!--end::Row 2-->
