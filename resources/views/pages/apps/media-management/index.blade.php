<x-default-layout>
    @section('title')
        <div class="d-flex justify-content-between align-items-between">
            <h1>Banner Album Media Management</h1>
            <div class="d-flex">
                <!--begin::Filter-->
                ...
                <a href="{{ route('media-management.add') }}">
                    <button type="button" class="btn btn-primary">
                        {!! getIcon('plus', 'fs-2', '', 'i') !!} Add Media
                    </button>
                </a>
                <!--end::Assign Gallery-->
            </div>
    ...
    @section('breadcrumbs')
        <h2>{{ Breadcrumbs::render('media-management.index') }}</h2>
    @endsection
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row align-items-center">
                                    <div class="col-md-4 mb-3">
                                        <div class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">Media Name:</div>    
                                        <br>
                                        <div class="d-flex align-items-center position-relative my-1">
                                            <input type="text" data-kt-user-table-filter="name" class="form-control form-control-solid w-250px" id="media_name" title="Search by name" style="background-color: rgb(245, 245, 245);"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">Media Type:</div>    
                                        <br>
                                        <div class="d-flex align-items-center position-relative my-1">
                                            <select class="form-select form-select-solid w-250px" name="media_type" id="mediaTypeSelect" data-kt-user-table-filter="media_type" title="Filter by media type" style="background-color: rgb(245, 245, 245);">
                            ...
                            <tr>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        ...
                                        <a href="{{ route('media-management.edit') }}" class="menu-link px-3">
                                            Edit
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
    ...
    <!--begin::Modals-->
    @include('pages/apps/media-management/model/confirmDeleteModel')
    <!--end::Modals-->
</x-default-layout>
