<x-default-layout>
    ...
    @section('title')
        <div class="d-flex justify-content-between align-items-between">
            ...
            <div class="d-flex">
                ...
                <a href="{{ route('news-management.add') }}">
                    <button type="button" class="btn btn-primary">
                        {!! getIcon('plus', 'fs-2', '', 'i') !!} Add News
                    </button>
                </a>
                <!--end::Assign Gallery-->
            </div>
    ...
    @section('breadcrumbs')
        <h2>{{ Breadcrumbs::render('news-management.index') }}</h2>
    @endsection
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-4 mb-3">
                                    <div class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">News Heading:</div>    
                                    <br>
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <input type="text" data-kt-user-table-filter="name" class="form-control form-control-solid w-250px" id="News" title="Search by News" style="background-color: rgb(245, 245, 245);"/>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                ...
                <div class="card-body">
                    ...
                    <table id="kt_datatable_example_1" class="table align-middle table-row-dashed fs-6 gy-5">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>1</td>
                                <td>{{ "The central bank of Nepal, the Nepal Rastra Bank (NRB), has published details of its policy strategy for the current fiscal year." }}</td>
                                <td>{{ "active" }}</td>
                                <td>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ route('news-management.view') }}" class="menu-link px-3">
                                            View
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ route('news-management.edit') }}" class="menu-link px-3">
                                            Edit
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
