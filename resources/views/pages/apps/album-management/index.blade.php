<x-default-layout>
    ...
    @section('title')
        ...
        <div class="d-flex justify-content-between align-items-between">
            <h1>Group 1's Album Management</h1>
            <div class="d-flex">
                <!--begin::Filter-->
                ...
                <a href="{{ route('album-management.add') }}">
                    <button type="button" class="btn btn-primary">
                        {!! getIcon('plus', 'fs-2', '', 'i') !!} Add Album
                    </button>
                </a>
                <!--end::Assign Gallery-->
            </div>
    ...
    @section('breadcrumbs')
        <h2>{{ Breadcrumbs::render('group-management.album') }}</h2>
    @endsection
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-4 mb-3">
                                    <div class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">Album Name:</div>    
                                    <br>
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <input type="text" data-kt-user-table-filter="name" class="form-control form-control-solid w-250px" id="album" title="Search by name" style="background-color: rgb(245, 245, 245);"/>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <br>
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <input type="text" data-kt-user-table-filter="email" class="form-control form-control-solid w-250px" id="group_name" title="Search by email" style="background-color: rgb(245, 245, 245);"/>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ route('album-management.edit') }}" class="menu-link px-3" data-kt-user-id="id">
                                            Edit
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ route('media-management.index') }}" class="menu-link px-3" data-kt-user-id="id" data-kt-action="delete_row">
                                            View Medias
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
                            ...
                            <tr>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ route('album-management.edit') }}" class="menu-link px-3" data-kt-user-id="id" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user" data-kt-action="update_row">
                                            Edit
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
