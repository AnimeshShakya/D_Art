<x-default-layout>
    @section('title')
        <h1>Edit Group ABC</h1>
    @endsection

    @section('breadcrumbs')
        <h2>{{ Breadcrumbs::render('group-management.edit') }}</h2>
    @endsection
                    ...
                    <div class="row mb-10">
                        <div class="col-md-4">
                            ...
                            <div class="mb-10">
                                ...
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid" placeholder="ABC Group" name="full_name" style="background-color: rgb(245, 245, 245);"/>
                                <!--end::Input-->
                            </div>
                            <!--end::Input Name-->
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="mb-10">
                                ...
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid" placeholder="User A" name="email" style="background-color: rgb(245, 245, 245);"/>
                                <!--end::Input-->
                            </div>
                            <!--end::Input Email-->
                        </div>
